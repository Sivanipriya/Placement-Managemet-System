       ...
       <!-- <div class="profile-photo-container">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li>
              <a href="../company/display.php"><i class="fa fa-bar-chart fa-fw"></i>Companies</a>
            </li>
            <li>+
              <a href="../company/applications.php"><i class="fa fa-bar-chart fa-fw"></i>Applications</a>
            </li>
            <li>
              <a href="../SProfile/logout.php"><i class="fa fa-eject fa-fw"></i>Sign Out</a>
            </li>
          </ul>
        </nav>
      </div>
